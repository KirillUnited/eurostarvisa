            ...
            type_links: [
                {
                    ...
                    name: 'tour',
                    link: '',
                    description: '<p>Виза в Великобританию для туризма выдается гражданам России на полгода. Даже если это первая британская виза. Находиться на территории Объединенного Королевства по такой визе можно не более 180 дней.</p><p>Обязательные документы:</p><ul><li> действующий заграничный паспорт<br> </li><li> предыдущие заграничные паспорта за последние 10 лет<br> </li><li> внутренний общегражданский паспорт<br> </li><li> финансовые документы: справка с работы, выписка из банка об остатке средств на счете<br> </li><li> для несовершеннолетних и пенсионеров потребуются финансовые документы спонсора поездки<br> </li><li> свидетельства о заключении брака и рождении детей при наличии<br> </li><li> не лишними будут и документы на движимое/недвижимое имущество: наличие собственности, ПТС и пр. при наличии </li><li> для несовершеннолетних так же требуется предоставить нотариально заверенное согласие на выезд, в случае, если поездка совершается с одним родителем или с третьим лицо </li></ul>'
                },
                {
                    type: 'business',
                    label: 'Бизнес виза',
                    name: 'business',
                    link: '',
                    description: '<p>Виза в Великобританию для туризма выдается гражданам России на полгода. Даже если это первая британская виза. Находиться на территории Объединенного Королевства по такой визе можно не более 180 дней.</p><p>Обязательные документы:</p><ul><li> действующий заграничный паспорт<br> </li><li> предыдущие заграничные паспорта за последние 10 лет<br> </li><li> внутренний общегражданский паспорт<br> </li><li> финансовые документы: справка с работы, выписка из банка об остатке средств на счете<br> </li><li> для несовершеннолетних и пенсионеров потребуются финансовые документы спонсора поездки<br> </li></ul>'
                },
                {
                    type: 'study',
                    label: 'Учебная виза',
